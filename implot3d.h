...
IMPLOT3D_TMP void PlotPrismLine(const char* label_id, const T* xs, const T* ys, const T* zs, int count, int const sides = 8, float wieght = -1.0f, ImPlot3DLineFlags flags = 0, int offset = 0,
				int stride = sizeof(T));
